public class Principal{
    public static void main(String[] args){
        ...
        double mediaPrimeiro = notasPrimeiro.media();
        double mediaSegundo = notasSegundo.media();
        double mediaTerceiro = notasTerceiro.media();
        System.out.println(mediaPrimeiro);
        System.out.println(mediaSegundo);
        System.out.println(mediaTerceiro);
